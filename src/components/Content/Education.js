...
const Education = ({collapsed, image, toggled, handleToggleSidebar, handleCollapsedChange, handleImageChange}) => {
    ...
    return (
        <main>
            ...
            <header>
                <h1>
                    <img width={80} src={reactLogo} alt="react logo" /> Education
                </h1>

                <p>This is a list of my education</p>

...
const Publications = ({collapsed, image, toggled, handleToggleSidebar, handleCollapsedChange, handleImageChange}) => {
    ...
    return (
        <main>
            ...
            <header>
                <h1>
                    <img width={80} src={reactLogo} alt="react logo" /> All Publications
                </h1>

                <p>This is a list of all my publications</p>
